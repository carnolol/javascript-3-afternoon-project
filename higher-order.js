...
let evenNumbers = mixedNumbers.filter(e => e % 2 ===0)// = mixedNumbers.filter(/* Provide Your Callback Here */)
...
//Code Here
let totalPopulation = populations.reduce((a,e) => {
  return a + e 
}, 0)
...
let myStrongest = monstersInYourPocket.filter((e) => {
 ...
 } // return monstersInYourPocket.CP
}, 0)
